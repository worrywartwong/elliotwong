...
# ESPECIALLY DO NOT EDIT WITH NOTEPAD IT WILL BREAK IT
...
BEGIN
{
  ...
  $postmaster        = '';
  @referers          = qw(francesbrann.com localhost);
  @allow_mail_to     = qw(francesbrann.com localhost);
  @recipients        = ();
  %recipient_alias   = ();
...
From: webmaster@francesbrann.com
...
sub send_main_email_body_header {
  ...
  $self->mailer->print(<<END);
Below are the results of your feedback form submitted by
